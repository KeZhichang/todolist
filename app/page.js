            ...
            >
              <div className="absolute left-1/2 -translate-x-1/2 z-10 flex items-center gap-2">
                ...
                <button
                  ...
                  className="bg-primary text-background rounded-b-lg py-2 px-2 pt-1"
                >
              ...
              >
                ...
                <div className="p-6 space-y-4 flex-1">
                  ...
                  >
                    ...
                    <span className="font-extrabold">{t('main.addTask')}</span>
                  </Button>
                  ...
                  >
                    ...
                    <span className="font-extrabold">{t('main.timer')}</span>
                  </Button>
                  ...
                  >
                    ...
                    <span className="font-extrabold">{t('main.habits')}</span>
                  </Button>
                </div>

                {/* Keyboard shortcuts hint */}
                <div className="p-6 pt-0 text-[10px] text-muted-foreground font-extrabold space-y-1 opacity-70">
                  <div>{t('main.ctrlA')}</div>
                  <div>{t('main.ctrlC')}</div>
                  <div>{t('main.ctrlH')}</div>
                  <div>{t('main.ctrlX')}</div>
                  <div>{t('main.esc')}</div>
                </div>
              </motion.div>
            </div>
