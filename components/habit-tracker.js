              ...
              {showAddForm ? (
                ...
                >
                  <motion.div variants={itemVariants}>
                    <Input
                      placeholder={t('habitTracker.whatHabitToBuild')}
                      value={newHabitName}
                  ...
                  <motion.div variants={itemVariants} className="space-y-3">
                    <Select value={selectedTag} onValueChange={setSelectedTag}>
                      <SelectTrigger className="border-2 border-gray-300 focus:border-primary/70 font-extrabold dark:border-gray-600 dark:focus:border-primary/80 dark:bg-gray-800 dark:text-gray-100 rounded-xl py-3">
                        <SelectValue placeholder={t('addTask.chooseCategory')} />
                      </SelectTrigger>
                    ...
                    >
                      ...
                      >
                        ...
                        {showAddTag ? t('common.cancel') : t('tasks.createNewCategory')}
                      </Button>
                    </motion.div>
                  </motion.div>
...
{t('habitTracker.createNewHabit')}
                      ...
                      <>
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <h3 className="font-extrabold text-gray-900 dark:text-gray-100">
                            {t('habitTracker.allHabitsOverview')}
                          </h3>
                        </div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 font-medium">
                          {totalCompletions} {t('habitTracker.totalCompletions')} • {habits.length}{" "}
                          {t('habitTracker.habits')}
                        </p>
                      </>
                    ) : (
                      <>
                    ...
                    >
                      <div className="flex flex-col gap-4 p-4 justify-center items-center bg-gray-50 dark:bg-gray-800/80 rounded-xl border-2 border-gray-200 dark:border-gray-700 h-[210px]">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                          {totalCompletions} {t('habitTracker.totalHabitCompletions')}
                        </div>
                      </div>
                    </motion.div>
                  ) : (
                    ...
                    currentHabit && (
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-4 p-4 justify-center items-center bg-gray-50 dark:bg-gray-800/80 rounded-xl border-2 border-gray-200 dark:border-gray-700 h-[210px]">
                          ...
                          <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                            {currentHabit.completedDates.length} {t('habitTracker.daysCompleted')} {t('habitTracker.thisMonth')}
                          </div>
                        </div>
                      </motion.div>
                    )
            ...
            {habits.length === 0 && !showAddForm && (
              ...
              >
                ...
                >
                  ...
                  <p className="font-extrabold text-lg">{t('habitTracker.noHabitsYet')}</p>
                  <p className="text-sm mt-1">
                    {t('habitTracker.addOneToStart')}
                  </p>
                </motion.div>
              </motion.div>
            )}
            ...
            >
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 font-medium">
                ...
                <span>{t('habitTracker.more')}</span>
              </div>
              <div className="text-center text-xs text-gray-400 dark:text-gray-500 mt-2 font-medium">
                {currentHabitIndex === -1
                  ? t('habitTracker.dailyHabitCompletions')
                  : t('habitTracker.individualHabitCompletion')}
              </div>
            </motion.div>
          </motion.div>
        </div>
