              ...
              <motion.div variants={itemVariants} className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-extrabold text-gray-700 dark:text-gray-200 uppercase tracking-wider flex items-center gap-2">
                    ...
                    {t('tasks.subtask')}s ({subtasks.length})
                  </label>
                  <Button
                    variant="ghost"
                    size="sm"
            ...
            <motion.div variants={itemVariants} className="space-y-3">
              ...
              <Select value={selectedTag} onValueChange={handleTagChange}>
                <SelectTrigger className="border-2 border-gray-300 focus:border-primary/70 font-extrabold dark:border-gray-600 dark:focus:border-primary/80 dark:bg-gray-800 dark:text-gray-100 rounded-xl py-3">
                  <SelectValue placeholder={t('tasks.chooseCategory')} />
                </SelectTrigger>
                <SelectContent className="rounded-xl border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                  ...
                  >
                    <span className="font-extrabold">{t('common.noCategory')}</span>
                  </SelectItem>
                  {customTags.map((tag) => (
                    <SelectItem
                      key={tag.id}
            ...
            <motion.div variants={itemVariants} className="space-y-3 pt-2">
              ...
              >
                ...
                >
                  ...
                  {task.completed ? t('common.markIncomplete') : t('common.markComplete')}
                </Button>
              </motion.div>
              ...
              {!task.isHabit && (
                ...
                >
                  ...
                  >
                    ...
                    {t('common.delete')} {isSubtask ? t('tasks.subtask') : t('settings.deleteTask')}
                  </Button>
                </motion.div>
              )}
            </motion.div>
