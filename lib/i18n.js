...
export const translations = {
  en: {
    ...
    landing: {
      ...
      openSourceDescription: "Prio Space is completely open source. Star the repository, contribute to the project, or fork it to make it your own.",
  ...
  zh: {
    ...
    landing: {
      ...
      github: "Github",
      openSource: "开源免费",
      openSourceDescription: "Prio Space 完全开源。给仓库点星、贡献代码，或者 fork 来制作你自己的版本。",
    ...
    landing: {
      ...
      github: "Github",
      openSource: "开源免费",
      openSourceDescription: "Prio Space 完全开源。给仓库点星、为项目贡献代码，或者分叉它来制作你自己的版本。",
      starOnGithub: "在 GitHub 上点星",
    },
...
export const setLanguage = (lang) => {
  if (translations[lang]) {
    ...
    if (typeof window !== 'undefined') {
      localStorage.setItem('priospace-language', lang);
    }
    return true;
  }
  return false;
...
export const initLanguage = () => {
  if (typeof window !== 'undefined') {
    const savedLang = localStorage.getItem('priospace-language');
